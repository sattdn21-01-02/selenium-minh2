...
public class LoginTest extends BaseTest {
    ...
    public void TC01() {
        ...
        LoggerHelper.info("[STEP-2] - Assert welcome message is displays");
    ...
    public void TC02(Account account) {
        LoggerHelper.startTestCase("TC02 - User can not log into Railway with valid username and password");
        homePage.goToLoginPage();
        LoggerHelper.info("[STEP-1] - Login fail with invalid account");
        loginPage.login(account.getEmail(), account.getPassword());

        LoggerHelper.info("[STEP-2] - Assert login error message email is displays");
    ...
    @Test
    public void TC03() {
        LoggerHelper.startTestCase("TC03 - User can not log into Railway with blank space username and password");
        homePage.goToLoginPage();
        LoggerHelper.info("[STEP-1] - Login fail with invalid account");
    ...
    @Test
    public void TC04() {
        LoggerHelper.startTestCase("TC04 - User can not log into Railway with blank space email ");
        homePage.goToLoginPage();
        LoggerHelper.info("[STEP-1] - Login fail with invalid account");
    ...
    @Test
    public void TC05() {
        LoggerHelper.startTestCase("TC05 - User can not log into Railway with blank space password ");
        homePage.goToLoginPage();
        LoggerHelper.info("[STEP-1] - Login fail with invalid account");
