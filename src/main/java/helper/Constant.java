...
public class Constant {
    ...
    public static final String FAIL_MSG_LOGIN_MULTIPLE = "You have used 4 out of 5 login attempts. After all 5 have been used, you will be unable to login for 15 minutes.";
